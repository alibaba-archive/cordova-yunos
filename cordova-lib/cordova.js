// Platform: yunos
// 80380e66896bc91ba28df4959253970dd7cb3d1b
/*
...
*/
;(function() {
var PLATFORM_VERSION_BUILD_LABEL = '6.5.1-dev';
...
/*
 * This file has been copied into the YunOS platform and patched
 * to fix a problem with replacing W3C APIs. We will have
 * to keep this file up-to-date with the common builder.js.
 */
...
function clobber(obj, key, value) {
    ...
    try {
        // YunOS patch
        var symbolPath = obj.constructor.name.toLowerCase() + '.' + key;
        if (obj[key] !== undefined) {
            window.CDV_origSymbols[symbolPath] = obj[key];
        }
        // YunOS end
        obj[key] = value;
    } catch (e) {
...
var yunosProxy = require('cordova/yunos/pluginmanagerproxy');
 ...
 */
function yunosExec (success, fail, service, action, args) {
    args = args || [];
